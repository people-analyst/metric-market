...
const ALIGNED_RANGE_ROWS: AlignedRangeRow[] = [
  {
    ...
    markers: [
      ...
      { label: "P2", value: 100000 },
      { label: "P3", value: 132000 },
      { label: "P4", value: 170000 },
      { label: "P5", value: 212000 },
      { label: "P6", value: 268000 },
      { label: "P7", value: 345000 },
    ],
  },
  {
    label: "P50",
  ...
  },
  {
    label: "P75",
    markers: [
      { label: "P1", value: 92000 },
      { label: "P2", value: 125000 },
      { label: "P3", value: 165000 },
      { label: "P4", value: 212000 },
